...
Dinosaur[] dinosaur=new Dinosaur[20];
Base base;
Power[] power=new Power[40];
...
void setup ()
{
  ...
  start = new Movie(this, "start.mp4");
  minim =new Minim(this);
  song= minim.loadFile("data/1.mp3");
  r1 = new Movie(this, "1.mp4");
  r2 = new Movie(this, "2.mp4");
  r3 = new Movie(this, "3.mp4");
